  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <span
          className={`inline-block capitalize text-[10px] px-1.5 py-0.5 rounded-full mt-0.5 ${
            TYPE_BADGE[entry.type] ?? 'bg-white/10 text-gray-300'
          }`}
        >
          {entry.type}
        </span>
      ...
      <div className="text-right flex-shrink-0">
        <p className="text-sm font-semibold text-white">{metric.toFixed(metric < 1 ? 4 : 1)}</p>
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Top Emitters */}
        <div className="rounded-2xl border border-red-100 bg-black/40 backdrop-blur-md p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            <div className="h-2 w-2 rounded-full bg-red-500" />
            <h3 className="text-sm font-semibold text-gray-200">Highest Total Emitters</h3>
        ...
        {/* Most Efficient */}
        <div className="rounded-2xl border border-green-100 bg-black/40 backdrop-blur-md p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            <div className="h-2 w-2 rounded-full bg-green-500" />
            <h3 className="text-sm font-semibold text-gray-200">Most Carbon Efficient</h3>
